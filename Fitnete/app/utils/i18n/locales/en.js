export default {
    ...
    exercises: {
        ...
        singleLegDeadliftRightLegDescription: 'With weight on the left leg, bend forward at the waist 90° allowing the arms to hang and the right leg to extend rearward, parallel to the ground, as a counter-balance.',

        singleLegDeadliftLeftLegName: 'Single Leg Deadlift - Left Leg',
        singleLegDeadliftLeftLegDescription: 'With weight on the right leg, bend forward at the waist 90° allowing the arms to hang and the left leg to extend rearward, parallel to the ground, as a counter-balance.',
        ...
        basicCrunchesDescription: 'Lying supine with knees bent 45°, place thumbs on ears to open chest and then contract abdominals to lift trunk toward the knees. Avoid pulling the head with the hands.',
